...
try {
  ...
  assert.equal(await page.getByLabel('Show only additional jobs (1)').isChecked(),true);
  console.log('PASS: page reload restores and highlights cached listings without a new provider search');
